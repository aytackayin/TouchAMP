...
## 🛠️ Service Installation (Apache, MySQL, PHP)

To keep the application portable, service binaries (Apache, MySQL, PHP) are not included by default. However, installation is straightforward:
1. Go to the **Settings** section in the application.
2. Click on the **Services** tab.
3. Click the **"How to install?"** button next to each service to follow the step-by-step guide.
4. Once downloaded, you can easily integrate the files using the **"Service Version Install"** button in the same section.
